      ...
      <div className="relative">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-3 gap-8 px-4 max-lg:grid-cols-1">
          {currentTiers.map((tier, index) => {
            // Add plan titles for each card
            let planTitle = '';
            if (activeTab === 'student') {
              if (index === 0) planTitle = 'Student';
              else if (index === 1) planTitle = 'Student+';
              else if (index === 2) planTitle = 'Student Pro';
            } else {
              if (index === 0) planTitle = 'Professional';
              else if (index === 1) planTitle = 'Professional+';
              else if (index === 2) planTitle = 'Professional Pro';
            }
            return (
              <div
                key={index}
                ...
                <div className="relative p-6">
                  ...
                  <div className="text-center mb-6">
                    <div className="mt-2.5">
                      <p className={`text-[1.375rem] font-bold mb-1 ${
                        activeTab === 'student' ? 'text-[#e61c71]' : 'text-violet-400'
                      }`}>{planTitle}</p>
