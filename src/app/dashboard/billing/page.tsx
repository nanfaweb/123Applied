...
export default function BillingPage() {
  ...
  // 1. If user has an active plan, show current plan UI
  if (plan) {
    ...
    return (
      <>
        <ScrollManager />
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-900 flex">
          {/* Sidebar placeholder: if you have a sidebar, render it here and make it fixed */}
          {/* <SidebarComponent /> */}
          <div className="flex-1 h-screen overflow-y-auto relative">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgb(203_213_225,0.15)_1px,transparent_0)] [background-size:24px_24px] pointer-events-none z-0" style={{ minHeight: '100%' }} />
  ...
  // 2. If user has billing history but no active plan
  if (history.length > 0) {
    return (
      <>
        <ScrollManager />
  ...
  // 3. If user has no billing history
